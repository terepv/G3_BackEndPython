...
@router.get("/", response_model=list[ComunaOut], summary="Obtener todas las comunas de un plan")
...
@router.post("/{id_comuna}", summary="Agregar una comuna a un plan", status_code=201)
...
@router.delete("/{id_comuna}", summary="Eliminar una comuna de un plan")
