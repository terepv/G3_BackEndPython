...
@router.get("/", response_model=list[Frecuencia], summary="Obtener todas las frecuencias")
...
@router.get("/{id_frecuencia}", response_model=Frecuencia, summary="Obtener una frecuencia por su id")
def read_frecuencia(
    id_frecuencia: int,
    db: SyncDbSessionDep,
):
...
@router.post("/", summary="Añade una frecuencia", status_code=201)
def add_frecuencia(
    db: SyncDbSessionDep,
...
@router.delete("/{id_frecuencia}", summary="Elimina una frecuencia")
